            ...
            <div className="sidemenucontainer" style={{paddingTop:'80px'}}>             
                <div className={props.activeicon==='Devices'? "sidebaricon active" : "sidebaricon"} onClick={()=>{window.location.href='home'}} onMouseEnter={()=>changeDevicesBoolean(true)} onMouseLeave={()=>changeDevicesBoolean(false)}>
                    ...
                    {devicesBoolean || subdevicesBoolean ?
                        ...
                        <b >DEVICES</b> 
                        <a style={{paddingTop:'10px'}} className="subsidebarmenu" href='home?add' style={{textDecoration:'none', color:"whitesmoke"}}>ADD DEVICES</a>
                ...
                {jobsBoolean || subjobsBoolean ?
                    ...
                    <div className="subsidebarmenu" onClick={()=>{window.location.href='events?add'}}>ADD EVENT</div>
                    ...
                    <div className={props.activeicon==='Chart'? "sidebaricon active" : "sidebaricon"} onMouseEnter={()=>changeChartsBoolean(true)} onClick={()=>window.location.href='Dashboard'} onMouseLeave={()=>changeChartsBoolean(false)}>
