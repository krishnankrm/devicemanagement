        ...
        return(<div className="modal fade" id="exampleModal34" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div className="modal-dialog modal-dialog-centered modal-lg">
                ...
                <div className="row-fluid" style={{display:'flex',flexWrap:'wrap'}} >
                        ...
                        {
                            protocol=='Modbus-TCP'?<div style={{paddingLeft:'10px', width:'218px'}}><label  className="form-label">Port</label>
                                <input  className="form-control" value={port}   onChange={(e)=>{changeport(e.target.value)}}  id='clrtagconfig4' ewq432 type='text'   />
                            </div>:''
                        }
                ...
                <div className="modal-footer">
                    {/* <button type="button" className="btn btn-primary btn-lg" onClick={()=>{changeloaderBool(true);Form_submit_TOconfigure()}}><div class = "spinner">
<div class = "dot"></div>
    <div class = "dot"></div>
    <div class = "dot"></div>
    <div class = "dot"></div>
    ...
    <div className="Configuration-MAin">
        ...
        <div style={{width:'calc(100vw - 50px)', height:'100vh', overflowY:"auto", paddingleft:"0",boxSizing:"content-box"}}>
                    ...
                    <br/>
                    <h4 style={{color:'brown', marginLeft:'100px'}}>Configuration Log</h4>
